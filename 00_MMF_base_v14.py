"""Based on 00_MMF_base_v13
Move the ticket counting routine into its own function - so that it can be
called each time a ticket is sold as well as at the end of the summary print.
Format currency correctly using a function (just before the main routine)
and, just above the frames, rearrange the snack, ticket and total profit
figures using the currency function
